...
public final class API {
	...
	public static evidence.vimeworld.Guild getGuild(String guildname) {
		try {
			String rawJson = readRequest("https://api.vimeworld.com/guild/get?name=" + guildname);
	...
	public static evidence.vimeworld.Guild getGuild(int id) {
		try {
			String rawJson = readRequest("https://api.vimeworld.com/guild/get?id=" + id);
			return new evidence.vimeworld.Guild(new JSONObject(rawJson));
		} catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static evidence.vimeworld.Player getPlayer(String player) {
		try {
			String rawJson = readRequest("https://api.vimeworld.com/user/name/" + player);
	...
	public static List<evidence.vimeworld.Player> getPlayers(Integer... ids) {
		...
		String rawJson = readRequest("https://api.vimeworld.com/user/" + parameter);
		try {
			JSONArray array = new JSONArray(rawJson);
